...
<!-- 신규등록 자바스크립트 -->
<script type="text/javascript" src="./resources/js/popupScript.js" ></script>
<!-- 페이지 스타일css -->
...
<form method="post" id="" name="joinForm">
	...
	<div id="sale-table">
		...
		<div class="custAddressWrap">
			...
			<input class="inputBox" id='TwoAddress' name="addrDtl" style="width: 165px;" placeholder="상세주소" onkeyup='Address();'>
			<br>
